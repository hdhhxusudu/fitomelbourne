  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6">
      ...
      <div className="relative overflow-hidden rounded-3xl border border-white/7 bg-linear-to-br from-white/5 to-transparent p-8 sm:p-10">
        <div
          className="pointer-events-none absolute -right-16 -top-16 h-48 w-48 rounded-full bg-emerald-500/9 blur-3xl"
          aria-hidden="true"
        />
        <div className="relative flex flex-col gap-6 sm:flex-row sm:items-end sm:justify-between">
          ...
          <div className="flex gap-6 text-center sm:shrink-0">
            <div>
              ...
              <div className="mt-0.5 text-[11px] uppercase tracking-wide text-emerald-300/55">
                SKUs
              </div>
            </div>
            <div>
      ...
      <div className="mt-8 flex items-center justify-between gap-4">
        ...
        <Link
          href="/products"
          className="inline-flex items-center gap-1.5 text-sm font-semibold text-emerald-200/65 transition hover:text-emerald-200 focus-visible:ring-2 focus-visible:ring-emerald-400/55"

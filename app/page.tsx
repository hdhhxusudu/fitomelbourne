  ...
  return (
    <div className="flex-1">
      ...
      >
        ...
        <div className="pointer-events-none absolute inset-0 bg-[linear-gradient(180deg,rgba(255,255,255,0.03)_0px,transparent_1px)] bg-size-[100%_64px] opacity-[0.35]" />
        <div className="pointer-events-none absolute inset-0 bg-[linear-gradient(90deg,rgba(255,255,255,0.02)_0px,transparent_1px)] bg-size-[64px_100%] opacity-30" />
